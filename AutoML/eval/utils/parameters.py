...
class ROCConfidenceParam(ConfidenceParam):
    ...
    def __init__(self, conf: None | float | dict) -> None:
        ...
        self._default_region = simultaneous_joint_confidence
        self._default_interval = hanley_mcneill_confidence
        super().__init__(conf)
...
class PRConfidenceParam(ConfidenceParam):
    ...
    def __init__(self, conf: None | float | dict) -> None:
        ...
        self._default_interval = logit_interval
        super().__init__(conf)
...
class PerformanceMetricConfidenceParam(ConfidenceParam):
    ...
    def __init__(self, conf: None | float | dict) -> None:
        ...
        self._default_region = agresti_coull_interval
        super().__init__(conf)
